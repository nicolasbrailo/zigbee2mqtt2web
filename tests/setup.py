...
def get_bridge_all_devs_msg():
    return [get_a_lamp(), get_broken_thing(), get_contact_sensor(),
            get_lamp_with_composite_action(), get_motion_sensor()]


def get_bridge_some_devs_msg():
    return [get_a_lamp(), get_broken_thing(), get_contact_sensor()]
