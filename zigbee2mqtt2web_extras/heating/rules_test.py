...
class RulesTest(unittest.TestCase):
    ...
    def test_fails_create_ScheduledMinTargetTemp(self):
        ...
        rules = create_rules_from_config(FakeZmw(), json.loads(SCHED_MIN_TEMP_EMPTY_CFG.format("""{"start": "10:00", "end": "11:00", "target_max_temp": 25, "target_min_temp": 20, "days": "all"}""")))
